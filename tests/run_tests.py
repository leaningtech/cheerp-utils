...
if not asmjs:
	tests = ['unit/downcast/test1.cpp',
		 ...
		 'unit/memory/test1.cpp','unit/memory/test2.cpp','unit/memory/test3.cpp',
			...
			'unit/memory/test7.cpp','unit/memory/test8.cpp','unit/memory/typedarrays_operator.cpp',
		 'unit/std/test1.cpp','unit/std/test2.cpp','unit/std/test3.cpp',
			...
			'unit/std/tostring.cpp','unit/std/stringhashing.cpp','unit/std/sscanf.cpp',
			'unit/std/gettimeofday.cpp','unit/std/chrono.cpp','unit/std/stringassign.cpp',
			'unit/std/stdmemfuncs.cpp',
		 ...
		 'unit/codegen/test1.cpp','unit/codegen/test2.cpp','unit/codegen/test3.cpp','unit/codegen/test4.cpp',
			 ...
			 'unit/codegen/escapes.cpp','unit/codegen/64bitenum.cpp','unit/codegen/64bitpointerarith.cpp',
	...
	tests = ['unit/downcast/test1.cpp',
		 ...
		 'unit/std/test1.cpp','unit/std/test2.cpp',
			#'unit/std/test3.cpp',
			#'unit/std/test4.cpp',
            'unit/std/test5.cpp','unit/std/test6.cpp',
			'unit/std/test7.cpp','unit/std/test8.cpp','unit/std/test9.cpp',
