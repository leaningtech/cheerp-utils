...
void webMain()
{
	...
	assertEqual(int32_t(f1), -0x80000000, "Float to int (signed) 1/3");
	assertEqual(int32_t(f2), 0x7fffff80, "Float to int (signed) 2/3");
	assertEqual(int32_t(f3), 0, "Float to int (signed) 3/3");
	...
	assertEqual(uint32_t(f2), 0x7fffff80, "Float to int (unsigned) 1/3");
	assertEqual(uint32_t(f3), 0, "Float to int (unsigned) 2/3");
	volatile uint32_t fu4 = uint32_t(f4); // Check for runtime crash
	assertEqual(uint32_t(f5), 0x80000000, "Float to int (unsigned) 3/3");
	...
	assertEqual(int32_t(d1), -0x80000000, "Double to int (signed) 1/3");
	assertEqual(int32_t(d2), 0x7fffffff, "Double to int (signed) 2/3");
	assertEqual(int32_t(d3), 0, "Double to int (signed) 3/3");
	...
	assertEqual(uint32_t(d2), 0x7fffffff, "Double to int (unsigned) 1/3");
	assertEqual(uint32_t(d3), 0, "Double to int (unsigned) 2/3");
	volatile uint32_t du4 = uint32_t(d4); // Check for runtime crash
	assertEqual(uint32_t(d5), 0x80000000, "Double to int (unsigned) 3/3");
}
