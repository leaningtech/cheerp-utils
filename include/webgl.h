...
public: 
    ...
    void uniform1fv(WebGLUniformLocation*, float*);
    void uniform1fv(WebGLUniformLocation*, double*);
    ...
    void uniform2fv(WebGLUniformLocation*, float*);
    void uniform2fv(WebGLUniformLocation*, double*);
    ...
    void uniform3fv(WebGLUniformLocation*, float*);
    void uniform3fv(WebGLUniformLocation*, double*);
    ...
    void uniform4fv(WebGLUniformLocation*, float*);
    void uniform4fv(WebGLUniformLocation*, double*);
