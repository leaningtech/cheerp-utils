...
set(__CHEERP_TARGET "$<TARGET_PROPERTY:CHEERP_TARGET>")
set(__HAS_CHEERP_TARGET "$<BOOL:${__CHEERP_TARGET}>")
set(__CHEERP_TARGET_OPT "$<${__HAS_CHEERP_TARGET}:--target=${__CHEERP_TARGET}>")
add_compile_options(${__CHEERP_TARGET_OPT})
add_link_options(${__CHEERP_TARGET_OPT})
